...
public static void main(String args[]) throws UnsupportedEncodingException{
	...
	if (pricture != null) {
		try {
			byte[] b = Base64.decodeLines(pricture);
			// 创建临时路径
			String filepath = "D:/shenyaSell/contactpricture";
			...
			// 照片名称
			String contractP = "/" + 1111 + "_" +token+"_" +22222 + ".jpg";
			// 写入的照片路径
			String contract_pricture_path = "D://";;
			FileOutputStream fos = new FileOutputStream(contract_pricture_path);
