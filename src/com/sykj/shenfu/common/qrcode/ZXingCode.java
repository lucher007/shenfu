package com.sykj.shenfu.common.qrcode;
...
import com.sykj.shenfu.common.qrcode.Base64;
...
public class ZXingCode {
	 ...
	 private static final int BGWHITE = 0xFFFFFFFF;   //背景颜色
	    public static void main(String[] args) throws WriterException {  
	        try {  
	            getLogoQRCode("https://www.sina.com.cn/", null, "新浪网链接");//这里表示扫描二维码后出现的网页，只需要把网址放上就可以了
	        } catch (Exception e) {
	            e.printStackTrace();  
	        }  
	    } 
	    ...
	    public static String getLogoQRCode(String qrUrl,HttpServletRequest request,String productName)  {
	    		 String filePath = request.getSession().getServletContext().getRealPath("/") + "images/mobilebusiness/logo.png";
	        //   filePath是二维码logo的路径，但是实际中我们是放在项目的某个路径下面的，所以路径用上面的，把下面的注释就好
	        //   String filePath = "E:/1.png";  //TODO<span style="color:#00cccc;"> <strong><span style="font-size:14px;">这里放的是你本地的图片路径</span></strong></span>
	    ...
	    public String addLogo_QRCode(BufferedImage bim, File logoPic, LogoConfig logoConfig, String productName) {
	        try {
	            ...
	            //后台生成并保存图片
	            //ImageIO.write(image, "png", new File("E:/" + new Date().getTime() + "test.png")); //TODO 
