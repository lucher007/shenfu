...
<script type="text/javascript">
	...
	function initProductinoutDatagrid(){
         $('#productinoutDG').datagrid({
              ...
              columns: [[
                  ...
                  { field: 'productidentfy', title: '产品识别号',width:100,align:"center",sortable:"true"},
	...
	function productformatter(value,row,index){
	 	var id = row.id;
	 	var updateContent = '<a class="btn-edit" href="javascript:updateProduct('+ id +');">修改</a>';
	 	var deleteContent = '<a class="btn-del" href="javascript:deleteProduct('+ id +');" >删除</a>';
	...
	function saveExportExcel(){
		$.dialog.confirm('确认是否导出？', function(){ 
			$("#searchForm").attr("action", "productinout/findProductinoutExportExcel");
			$("#searchForm").submit();
		}, function(){
