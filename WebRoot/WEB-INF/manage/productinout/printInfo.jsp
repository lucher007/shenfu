...
<div class="printInfo">
    	<table border=1 cellSpacing=1 cellPadding=1 width="100%" style="border-collapse:collapse;bordercolor:#333333;font-size:9pt;">
        	<caption><b><font face="黑体" size="4">产品出入库清单</font></b><br></br></caption>
        	<tr height="30">
        	...
        	<c:forEach items="${productinout.productinoutlist }" var="dataList">
		        	<tr height="30" >
		        		<td width="40%" align="center">${dataList.productname }</td>
