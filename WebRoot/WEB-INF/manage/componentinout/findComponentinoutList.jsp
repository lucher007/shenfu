...
<script type="text/javascript">
	...
	function initComponentinoutDatagrid(){
         $('#componentinoutDG').datagrid({
              ...
              url:'componentinout/findListJson',
              pagination: true,
              singleSelect: true,
              scrollbar:true,
              pageSize: 10,
	...
	function componentformatter(value,row,index){
	 	var id = row.id;
	 	var updateContent = '<a class="btn-edit" href="javascript:updateComponent('+ id +');">修改</a>';
	 	var deleteContent = '<a class="btn-del" href="javascript:deleteComponent('+ id +');" >删除</a>';
	...
	function saveExportExcel(){
		$.dialog.confirm('确认是否导出？', function(){ 
			$("#searchForm").attr("action", "componentinout/findComponentinoutExportExcel");
			$("#searchForm").submit();
		}, function(){
