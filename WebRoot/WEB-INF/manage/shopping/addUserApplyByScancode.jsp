...
<body>
	<form class="am-form am-form-horizontal" id="addForm" method="post" >
		...
		<div class="am-form-group">
		    <div class="am-u-sm-offset-2 am-u-sm-10">
		      <div class="checkbox">
		        <label>
		          <input type="checkbox" id="readedUserBook" name="readedUserBook"> 
		         	 <a href="sale/downloadTemplate" class="btn-print">我已阅读并同意《产品试用协议书》</a> 
		          <br>
		        </label>
		      </div>
		    </div>
	...
	function checkVal() {
		...
		if(!(/^1[34578]\d{9}$/.test($("#phone").val()))){ 
			$.dialog.tips("手机号码有误，请重填", 1, 'alert.gif');
	        return false; 
	    } 
		...
		if ($("#readedUserBook").is(":checked") != true) {
			//$("#readedUserBook").focus();
			$.dialog.tips("请先阅读并同意产品试用说明书", 1, 'alert.gif');
			return false;
		}
	...
	function saveUserBuyOrder() {
		...
		$("#addForm").attr("action", "sale/savePaymentInfoInit_getCode?rid="+Math.random());
		$("#addForm").submit();
	}
