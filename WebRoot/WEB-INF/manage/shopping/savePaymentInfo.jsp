...
<body>
	<form method="post" id="addForm" name="addForm">
		<input type="hidden" name="usercode" id="usercode" value="${userpaylog.usercode}"/>
		<input type="hidden" name="jumpurl" id="jumpurl" value="${userpaylog.jumpurl}"/>
		<input type="hidden" name="code" id="code" value="${code}"/>
		<input type="hidden" name="openid" id="openid" value="${openid}"/>
		<header data-am-widget="header" class="am-header am-header-default am-header-fixed">
		       <div class="am-header-left am-header-nav">
		          <a href="${userpaylog.jumpurl}" class="">
		   ...
		   WeixinJSBridge.invoke(
		      ...
		      function(res){
			      if(res.err_msg == "get_brand_wcpay_request:ok" ){
			    	...
			    	$("#addForm").attr("action", "sale/addUserApplyByScancodeInit?rid="+Math.random());
			    	$("#addForm").submit();
