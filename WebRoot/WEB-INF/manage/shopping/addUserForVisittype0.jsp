...
<body>
	...
	<header data-am-widget="header" class="am-header am-header-default am-header-fixed">
	      ...
	      <h1 class="am-header-title">申请体验</h1>
  	</header>
	...
	<div>
			...
			<div style="height: 15px;"></div>
			<div class="info-btn">
				<button type="button" class="am-btn am-alert am-btn-block" style="height: 50px;" onclick="javascript:saveUserBuyOrder();">提交</button>
			</div>
...
<!--[if (gte IE 9)|!(IE)]><!-->
<script src="shopping/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
<!--<![endif]-->
<!--[if lte IE 8 ]>
...
<![endif]-->
<script src="shopping/AmazeUI-2.4.2/assets/js/amazeui.min.js"></script>
...
<script type="text/javascript">
	...
	function saveUserBuyOrder() {
		...
		$('#my-confirm').modal({
	        ...
	        onConfirm: function(options) {
	        	$("#addForm").attr("action", "sale/saveUserAddOrderForVisittype0?rid="+Math.random());
				$("#addForm").submit();
	        },
	        onCancel: function() {
	         	return false
	...
	function rebackMain1() {
		$("#addForm").attr("action", "sale/uploadimage?rid="+Math.random()+"&salercode="+$("#salercode").val());
		$("#addForm").submit();
	}
