		...
		<form method="post" id="addForm" name="addForm">
			...
			<div id="ft" style="padding:5px;">
					<cite> 
						...
						<a href="javascript:saveOutdepot();" class="easyui-linkbutton" iconCls="icon-save" style="width:80px">材料入库</a>
...
<script type="text/javascript">
  ...
  function saveOutdepot() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "materialdepot/updateDepotamount?rid="+Math.random());
				$("#addForm").submit();
