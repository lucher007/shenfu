...
<body>
	<div id="body">
		<form method="post" id="addForm" name="addForm">
			<div class="easyui-panel" style="width:100%;" title="材料入库" data-options="footer:'#ft'">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td>
							<input type="text" class="inp easyui-numberbox" name="depotamount" id="depotamount" value="${materialdepot.depotamount}" /> <span class="red">*</span>
						</td> 
					</tr>
					<tr>
	...
	function checkVal() {
		...
		if ($('#materialcode').combobox('getValue') == "") {
			$.dialog.tips("请选择入库材料", 1, "alert.gif", function() {
				$("#materialcode").focus();
			});
			return false;
		}
		...
		if ($("#depotamount") != undefined && ($("#depotamount").val() == "" || $("#depotamount").val() == null )) {
			$.dialog.tips("请输入材料入库量", 1, "alert.gif", function() {
				$("#depotamount").focus();
			});
			return false;
		}
	...
	function saveIndepot() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "materialdepot/saveIndepot?rid="+Math.random());
				$("#addForm").submit();
		...
		//$("#addForm").attr("action", "materialdepot/saveIndepot");
	    //$("#addForm").submit();
	}
