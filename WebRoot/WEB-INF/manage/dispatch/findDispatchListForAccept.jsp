...
<body>
    ...
    <div id="tools">
		<div style="margin-bottom:5px">
			<a href="javascript:acceptDispatch();" class="easyui-linkbutton" iconCls="icon-tip"  plain="true">工单接收</a>
...
function initDispatchDatagrid(){
	...
	*/
	function acceptDispatch(){
		...
		$.dialog.confirm('确认接收工单？', function(){ 
			var data = {
					     id: id
					   };
			var url="userdispatch/updateForAccept?rid="+Math.random();
