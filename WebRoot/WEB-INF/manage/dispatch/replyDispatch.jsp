		...
		<div class="form-box">
				...
				<div class="easyui-panel" title="安装信息" style="width:100%;">
					<table style="width:100%">
						<tr>
							...
							<td align="right">安装人员姓名：</td>
							<td>
								<input type="text" class="inp" name="installername" id="installername" readonly="readonly" style="background:#eeeeee;" value="${userdispatch.userdispatch.installer.employeename}">
							</td>
							<td align="right">联系电话：</td>
							<td colspan="3"><input type="text" class="inp" name="installerphone" id="installerphone" readonly="readonly" style="background:#eeeeee;" value="${userdispatch.userdispatch.installer.phone}"></td>
							<!--
						...
						<tr>
							...
							<td >
								<select id="status" name="status" class="select">
									<option value="3" <c:if test="${userdispatch.status == '3'}">selected</c:if>>成功处理</option>
				            ...
				            <td colspan="3"> 
								<textarea id="dealresult" name="dealresult" style="width:400px; height:50px;"
			                       onKeyDown="checkLength('dealresult',100)" onKeyUp="checkLength('dealresult',100)">${userdispatch.dealresult}</textarea>
			...
			<div id="ft" style="padding:5px;">
					<cite> 
						...
						<a href="javascript:updateReply();" class="easyui-linkbutton" iconCls="icon-save" style="width:80px">保存</a>
...
// 		}
  ...
  function updateReply() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "userdispatch/saveReply?rid="+Math.random());
				$("#addForm").submit();
		...
		//$("#addForm").attr("action", "userdispatch/saveReply");
	    //$("#addForm").submit();
	}  
