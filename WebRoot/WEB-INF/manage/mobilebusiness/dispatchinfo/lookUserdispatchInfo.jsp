...
<body>
	<form method="post" id="addForm" name="addForm" class="am-form am-form-horizontal" >
		...
		<header data-am-widget="header" class="am-header am-header-default am-header-fixed">
		       <div class="am-header-left am-header-nav">
		          <a href="mobilebusiness/findUserdispatchListForStatus34" class="">
		              <img class="am-header-icon-custom" src="data:image/svg+xml;charset&#x3D;utf-8,&lt;svg xmlns&#x3D;&quot;http://www.w3.org/2000/svg&quot; viewBox&#x3D;&quot;0 0 12 20&quot;&gt;&lt;path d&#x3D;&quot;M10,0l2,2l-8,8l8,8l-2,2L0,10L10,0z&quot; fill&#x3D;&quot;%23fff&quot;/&gt;&lt;/svg&gt;" alt=""/>
		              <span class="am-header-nav-title">返回 </span>
		          </a>
		       </div>
		       <h1 class="am-header-title">工单详情</h1>
		</header>
		...
		<div style="padding-bottom: 50px; ">
			...
			<hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
			<div class="am-form-group">
				<label for="dispatchcode" class="am-form-label am-u-sm-3" >工单编号</label>
				<div class="am-form-content am-u-sm-9" align="right">
					${userdispatch.userdispatch.dispatchcode}
				</div>
			</div>
			<hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
			<div class="am-form-group">
				<label for="dispatchcode" class="am-form-label am-u-sm-3" >工单内容</label>
				<div class="am-form-content am-u-sm-9" align="right">
			...
			<hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
			<div class="am-form-group">
				<label for="ordercode" class="am-form-label am-u-sm-3" >订单编号</label>
				<div class="am-form-content am-u-sm-9" align="right">
					${userdispatch.userdispatch.ordercode}
				</div>
			</div>
			<hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
			<div class="am-form-group">
			...
			<hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
			<div class="am-form-group">
				<label for="firstpayment" class="am-form-label am-u-sm-3">首款金额</label>
				<div class="am-form-content am-u-sm-9" align="right">
			...
			<hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
			<div class="am-form-group">
				<label for="address" class="am-form-label am-u-sm-3">尾款金额</label>
				<div class="am-form-content am-u-sm-9" align="right">
			...
			<hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
			<div class="am-form-group">
				<label for="username" class="am-form-label am-u-sm-3" >处理时间</label>
				<div class="am-form-content am-u-sm-9" align="right">
					${fn:substring(userdispatch.userdispatch.dealdate, 0, 19)}
				</div>
			</div>
			
			<hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
			<div class="am-form-group" onclick="javascript:updateDispatchfile();">
				<label for="userdispatchfile" class="am-form-label am-u-sm-3">安装图片</label>
				<div class="am-form-content am-u-sm-9" align="right"><span style="color: red">点击查看</span>
			...
			<div class="am-form-group">
		     	 	...
		     	 	<div class="am-form-content am-u-sm-9">
		     	 		<textarea class="" id="dealresult" name="dealresult">${userdispatch.userdispatch.dealresult}</textarea>
		     	 	</div>
		    </div>
			
			<hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
			<c:if test="${userdispatch.returninfo ne null && userdispatch.returninfo ne ''}">
				<div id="returninfo"  class="am-alert am-alert-success" data-am-alert >
			 		 <p>${userdispatch.returninfo}</p>
				</div>
				<hr data-am-widget="divider" style="" class="am-divider am-divider-default" /> 
			</c:if>  
		</div>
	...
	<script type="text/javascript">
		function updateDispatchfile() {
			var dispatchcode = $("#dispatchcode").val(); 
			$("#addForm").attr("action", "mobilebusiness/updateDispatchfileInit?rid="+Math.random());
			$("#addForm").submit();
		}
	</script>
</body>
