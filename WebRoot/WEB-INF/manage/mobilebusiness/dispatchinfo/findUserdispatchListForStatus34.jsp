...
<body>
	...
	<header data-am-widget="header" class="am-header am-header-default am-header-fixed">
	       ...
	       <h1 class="am-header-title">已处理工单</h1>
	</header>
	<div class="content">
                        ...
                        if(listdata.length > 0){
                        	for(var i = 0; i < listdata.length; i++){
                            	 result +=   '<tr class="lb-list">'
                            	         +     '<td>'+ listdata[i].username + '<input type="hidden" value="'+ listdata[i].dispatchcode+'">' + '</td>'
	...
	function lookUserdispatch(dispatchcode) {
		...
		$("#addForm").attr("action", "mobilebusiness/lookUserdispatchInfo?rid="+Math.random()+"&dispatchcode="+dispatchcode);
		$("#addForm").submit();
