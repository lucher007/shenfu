...
<body>
	...
	<header data-am-widget="header" class="am-header am-header-default am-header-fixed">
	       ...
	       <h1 class="am-header-title">订单管理</h1>
	...
	function lookUserorder(type,value) {
		if(type == 'ing'){
			$("#addForm").attr("action", "mobilebusiness/lookUserorder_ing?rid="+Math.random()+"&ordercode="+value);
			$("#addForm").submit();
		}else if(type == 'ed'){
			$("#addForm").attr("action", "mobilebusiness/lookUserorder_ed?rid="+Math.random()+"&ordercode="+value);
			$("#addForm").submit();
		}
	}
