...
<body>
	...
	<script type="text/javascript">
		...
		function savePaymentInfo(payitem) {
			$("#addForm").attr("action", "mobilebusiness/savePaymentInfoInit_getCode?rid="+Math.random()+"&payitem="+payitem+"&jumpurl=mobilebusiness/lookUsertask_ed");
			$("#addForm").submit();
		}
		
		function updateUserdoordata() {
			var ordercode = $("#ordercode").val(); 
			$("#addForm").attr("action", "mobilebusiness/updateUserdoordataInit?rid="+Math.random()+"&jumpurl=mobilebusiness/lookUsertask_ed");
			$("#addForm").submit();
		}
		
		function updateUserdoor() {
			var ordercode = $("#ordercode").val(); 
			$("#addForm").attr("action", "mobilebusiness/updateUserdoorInit?rid="+Math.random()+"&jumpurl=mobilebusiness/lookUsertask_ed");
			$("#addForm").submit();
		}
		
		function updateProductfee() {
			var ordercode = $("#ordercode").val(); 
			$("#addForm").attr("action", "mobilebusiness/updateProductfeeInit?rid="+Math.random()+"&jumpurl=mobilebusiness/lookUsertask_ed");
			$("#addForm").submit();
		}
