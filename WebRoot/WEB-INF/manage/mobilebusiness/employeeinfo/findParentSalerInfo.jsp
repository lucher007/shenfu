...
<body>
	<form method="post" id="addForm" name="addForm">
		...
		<header data-am-widget="header" class="am-header am-header-default am-header-fixed">
		       ...
		       <h1 class="am-header-title">引入人资料</h1>
		       <hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
		</header>
		<div style="height: 15px;"></div>
		<div style="padding-bottom: 50px; ">
			<div class="am-form-group">
				<label for="employeecode" class="am-form-label am-u-sm-6" >引入人编号</label>
			...
			<hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
			<div class="am-form-group">
				<label for="employeename" class="am-form-label am-u-sm-6">引入人姓名</label> 
				<div class="am-form-content am-u-sm-6" align="right">
			...
			<hr data-am-widget="divider" style="" class="am-divider am-divider-default" />
			<div class="am-form-group">
				<label for="address" class="am-form-label am-u-sm-6">客户电话</label>
				<div class="am-form-content am-u-sm-6" align="right">
