...
<body>
	<div id="body">
		<form method="post" id="addForm" name="addForm">
			<div class="easyui-panel" style="width:100%;" data-options="footer:'#ft'">
				<div class="easyui-panel" title="型号信息" style="width:100%;">
					<table width="100%" >
						<tr>
							<td height="30" width="15%" align="right">型号编码：</td>
							<td width="25%"><input type="text" class="easyui-textbox" name="modelcode" id="modelcode" value="${productmodel.modelcode }"> <span class="red">*</span></td>
						</tr>
						<tr>
							<td height="30" width="15%" align="right">型号名称：</td>
							<td width="25%"><input type="text" style="width:300px" class="easyui-textbox" name="modelname" id="modelname" value="${productmodel.modelname }"> <span class="red">*</span></td>
						</tr>
						<tr>
							<td align="right">产品价格：</td>
							<td>
								<input type="text" class="inp easyui-numberbox" name="price" id="price"  value="${productmodel.price }" maxlength="8"> <span class="red">*</span>
							</td> 
						</tr>
						<tr>
							<td align="right">销售价格：</td>
							<td>
								<input type="text" class="inp easyui-numberbox" name="sellprice" id="sellprice"  value="${productmodel.sellprice }" maxlength="8"> <span class="red">*</span>
							</td> 
						</tr>
						<!-- 
						<tr>
							...
							<td>
								<input type="text" class="inp easyui-numberbox" name="maxprice" id="maxprice"  value="${productmodel.maxprice }" maxlength="8"> <span class="red">*</span>
							</td> 
						</tr>
						<tr>
							<td align="right">最小浮动价格：</td>
							<td>
								<input type="text" class="inp easyui-numberbox" name="minprice" id="minprice"  value="${productmodel.minprice }" maxlength="8"> <span class="red">*</span>
							</td> 
						</tr>
						 -->
						...
						<tr>
							...
							<td>
								<input type="text" class="inp easyui-numberbox" name="discountgain" id="discountgain"  value="${productmodel.discountgain }" maxlength="8"> <span class="red">*</span>
							</td> 
						</tr>
						<tr>
							<td align="right">固定返利金额：</td>
							<td>
								<input type="text" class="inp easyui-numberbox" name="fixedgain" id="fixedgain"  value="${productmodel.fixedgain }" maxlength="8"> <span class="red">*</span>
							</td> 
						</tr>
						<tr>
							<td align="right">销售管家提成：</td>
							<td>
								<input type="text" class="inp easyui-numberbox" name="managergain" id="managergain"  value="${productmodel.managergain }" maxlength="8"> <span class="red">*</span>
							</td> 
						</tr>
						<tr>
							<td align="right">有效开始时间：</td>
							<td>
								<input type="text" id="starttime" name="starttime" value="${fn:substring(productmodel.starttime, 0, 19)} " style="width: 200px;"
						...
						<tr>
							...
							<td>
								<input type="text" id="endtime" name="endtime" value="${fn:substring(productmodel.endtime, 0, 19)}" style="width: 200px;"
		                    	onclick="WdatePicker({lang:'${locale}',skin:'blueFresh',isShowWeek:true,isShowClear:true,dateFmt:'yyyy-MM-dd HH:mm:ss'});" class="Wdate inp">
							</td> 
						</tr>
						<tr>
							...
							<td>
								<select id="status" name="status" class="easyui-combobox" style="width:143px;">
									<option value="0" <c:if test="${productmodel.status == '0' }">selected</c:if>>未发布</option>
				    			    <option value="1" <c:if test="${productmodel.status == '1' }">selected</c:if>>正式发布</option>
					            </select>
							</td> 
						</tr>
						<tr>
				            ...
				            <td width="25%"> 
								<textarea id="content" name="content" style="width:450px; height:50px;"
			                       onKeyDown="checkLength('content',100)" onKeyUp="checkLength('content',100)">${productmodel.content}</textarea>
			...
			<div id="ft" style="padding:5px;">
				<cite> 
					...
					<a href="javascript:saveProductmodel();" class="easyui-linkbutton" iconCls="icon-save" style="width:80px">保存</a>
			    </cite><span class="red">${productmodel.returninfo}</span>
			</div>
	...
	function saveProductmodel() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "productmodel/save?rid="+Math.random());
				$("#addForm").submit();
	...
	function paramsJson(){
		...
		var modelcode = '${productmodel.modelcode}';
