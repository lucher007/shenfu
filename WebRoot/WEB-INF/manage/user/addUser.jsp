				...
				<div class="easyui-panel" title="订户信息" style="width:100%;">	
					<table style="width: 100%">
						...
						<tr>
							...
							<td width="85%"><input type="text" class="inp" name="username" id="username" value="${user.username }"> <span class="red">*</span></td>
						</tr>
						<tr>
							<td height="30" width="15%" align="right">联系电话：</td>
							<td width="85%"><input type="text" class="inp" name="phone" id="phone" value="${user.phone }" maxlength="12" onkeyup="checkNum(this)" onkeypress="checkNum(this)" onblur="checkNum(this)" onafterpaste="this.value=this.value.replace(/\D/g,'')">
							<span class="red">*</span></td>
						</tr>
						<tr>
							<td height="30" width="15%" align="right">安装地址：</td>
							<td width="85%">
								<input type="text" class="inp" style="width: 350px" name="address" id="address" value="${user.address }"/>
								<span class="red">*</span>
							</td>
						</tr>
						<tr>
