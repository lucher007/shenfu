...
<body>
	...
	<form action="" method="post" id="addForm" name="addForm">
   		<div class="seh-box">
        	<input type="hidden" id="jumpurl" name = "jumpurl" value="batchAdd">
            <table width="100%">
		    	<tr>
		    		<td align="right" width="10%">客户姓名：</td>
		    		<td width="20%">
		    			<input type="text"  class="inp w200" name="username" id="username" >
		    		</td>
		    		<td align="right" width="10%">电话号码：</td>
		    		<td width="20%">
		    			<input type="text"  class="inp w200" name="phone" id="phone" >
		    		</td>
		    	...
		    	<tr>
		    		...
		    		<td width="20%">
		    			<input type="text"  class="inp w200" name="address" id="address">
		    		</td>
        			...
        			<td >
        				<select id="visittype" name="visittype" class="select" onchange="queryUser();">
			                   <option value="0" <c:if test="${usertask.visittype == '0' }">selected</c:if>>公司派人讲解测量</option>
			             </select>
        			</td>
		    	</tr>
   		    </table>
...
<script type="text/javascript">
	...
	function saveTask() {
	    ...
	    $.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "task/saveTaskForBatchAdd?usercodes="+usercodes+"&rid="+Math.random());
				$("#addForm").submit();
