...
<script type="text/javascript">
              ...
              columns: [[
                  ...
                  { field: '1', title: '手绘图' ,width:100,align:"center",
	            		    formatter:function(val, row, index){ 
							    ...
							    var updateContent = '<a class="btn-test" href="javascript:lookHanddrawing('+ id +','+ taskno +');">上传</a>';
				  ...
				  //		 	var id = row.id;
					//		 	var taskno = row.taskno;
					//		    var updateContent = '<a class="btn-test" href="javascript:updateForHanddrawing('+ id +','+ taskno +');">完成手绘图</a>';
					//			return  updateContent;
                  	//        },
                  //},
              ]]
    ...
    function lookHanddrawing(taskid,taskno) {	
	 ...
	 /**
		*任务单接收
		*/
		function updateForHanddrawing(id){
			
			$.dialog.confirm('确认完成手绘图上传？', function(){ 
				var data = {
						     id: id
						   };
				var url="task/updateForHanddrawing?rid="+Math.random();
