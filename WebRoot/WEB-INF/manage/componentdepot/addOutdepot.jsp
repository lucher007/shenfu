...
<body>
	<div id="body">
		<form method="post" id="addForm" name="addForm">
			...
			<div class="easyui-panel" title="元器件出库信息" style="width:100%;" data-options="footer:'#ft'">
				<table style="width:100%">
					...
					<tr>
						...
						<td>
							<input type="text" class="inp w200" name="inoutercode" id="inoutercode" readonly="readonly" style="background:#eeeeee;width: 200px;" value="${componentdepot.inoutercode }">
					...
					<tr>
						...
						<td>
							<input type="text" class="inp w200" name="inoutername" id="inoutername" readonly="readonly" style="background:#eeeeee;width: 200px;" value="${componentdepot.inoutername }">
						</td>
					</tr>
				</table>
			</div>
			<div id="ft" style="padding:5px;">
					<cite> 
						...
						<a href="javascript:saveOutdepot();" class="easyui-linkbutton" iconCls="icon-save">元器件出库</a>
...
<script type="text/javascript">
  ...
  function saveOutdepot() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "componentdepot/saveOutdepot?rid="+Math.random());
				$("#addForm").submit();
