...
<body>
		...
		<form method="post" id="addForm" name="addForm">
			<div class="easyui-panel" title="货柜信息" style="width:100%;">	
				<table >
					<tr>
						...
						<td width="25%"><input type="text" class="inp" name="depotrackcode" id="depotrackcode" value="${depotrack.depotrackcode }"> <span class="red">*</span></td>
						<td height="30" width="15%" align="right">货柜名称：</td>
						<td width="25%"><input type="text" class="inp " name="depotrackname" id="depotrackname" value="${depotrack.depotrackname }" ><span class="red">*</span></td>
					<tr>
					</tr>
						<td width="15%" align="right">总层数：</td>
						<td width="25%"><input type="text" class="inp easyui-numberbox" name="rownums" id="rownums" value="${depotrack.rownums }" maxlength="2" >
						<td align="right">总列数：</td>
						<td width="25%"><input type="text" class="inp easyui-numberbox" name="columnnums" id="columnnums" value="${depotrack.columnnums }" maxlength="2" >
		    ...
		    <div id="ft" style="padding:5px;">
					<cite> 
						...
						<a href="javascript:saveDepotrack();" class="easyui-linkbutton" iconCls="icon-save" style="width:80px">保存</a>
	...
	function saveDepotrack() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "depotrack/save?rid="+Math.random());
				$("#addForm").submit();
	...
	$(function () {
       ...
       if('${depotrack.id}' != null &&  '${depotrack.id}' != ""){
    	   addDepotrack();
       }
