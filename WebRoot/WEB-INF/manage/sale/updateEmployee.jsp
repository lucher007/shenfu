    ...
    <div class="easyui-panel" title="员工信息" style="width:100%;">	
        <table>
			...
			<tr>
				...
				<td width="25%"><input type="text" class="inp" name="address" id="address" style="width:350px;" value="${employee.employee.address }"></td>
			...
			<tr>
				...
				<td align="right">登录APP密码：</td>
				<td>
					<input type="password" class="inp" name="apppassword" id="apppassword" value="${employee.employee.apppassword }"> <span class="red">*</span>
				</td>
			</tr>
			<tr>
      ...
      <div class="form-box">
			<div class="fb-bom">
				...
				<span class="red">${employee.returninfo}</span>
			</div>
	  </div>
  </form>
</div>
