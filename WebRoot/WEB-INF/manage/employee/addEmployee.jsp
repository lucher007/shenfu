				...
				<div class="easyui-panel" title="员工信息" style="width:100%;">	
					<table>
						<tr>
							...
							<td width="15%" height="30" align="right">员工姓名：</td>
						...
						<tr>
							...
							<td height="40px" width="15%" align="right">生日：</td>
							<td width="25%">
						...
						<tr>
							...
							<td width="25%" ><input type="text" class="inp" name="address" id="address" style="width:400px;" value="${employee.address }"></td>
