...
<body>
		<div class="form-box">
			<form method="post"  enctype="multipart/form-data" id="addForm" name="addForm" >
				<input id="ordercode" name="ordercode" type="hidden" value="${usercontract.ordercode}"/> 
				<div class="easyui-panel" title="合同信息" style="width:100%;" data-options="footer:'#ft'">
    ...
    function plupload(){
		...
		$("#uploader").plupload({
			...
			url : '<%=basePath%>usercontract/saveUsercontractInfo',
			 // 参数  
            multipart_params: {	
            					'ordercode': ordercode, 
                              },
