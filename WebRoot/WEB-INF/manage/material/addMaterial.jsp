...
<body>
	<div id="body">
		<form method="post" id="addForm" name="addForm">
			<div class="easyui-panel" title="任务单信息" style="width:100%;" data-options="footer:'#ft'">
				<table width="100%">
					<tr>
						<td height="30" width="15%" align="right">材料编号：</td>
						<td width="25%"><input type="text" class="inp" name="materialcode" id="materialcode" value="${material.materialcode }"> <span class="red">*</span></td>
					</tr>
					<tr>
						<td height="30" width="15%" align="right">材料名称：</td>
						<td width="25%"><input type="text" class="inp" name="materialname" id="materialname" value="${material.materialname }"> <span class="red">*</span></td>
					</tr>
					<tr>
						<td align="right">材料计算单位：</td>
						<td><input type="text" class="inp" name="materialunit" id="materialunit" value="${material.materialunit }"></td>
					</tr>
					<tr>
						<td align="right">材料来源：</td>
						<td>
							<select id="materialsource" name="materialsource" class="select">
								<option value="1" <c:if test="${material.materialsource == '1'}">selected</c:if>>外购</option>
								<option value="0" <c:if test="${material.materialsource == '0'}">selected</c:if>>自产</option>
							</select>
						</td>
					</tr>
					<tr>
						<td align="right">报警量：</td>
						<td><input type="text" class="inp easyui-numberbox" name="depotamount" id="depotamount" value="${material.depotamount }" ></td>
					</tr>
				</table>
			</div>
			<div id="ft" style="padding:5px;">
				<cite> 
					...
					<a href="javascript:saveMaterial();" class="easyui-linkbutton" iconCls="icon-save" style="width:80px">保存</a>
	...
	function saveMaterial() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "material/save?rid="+Math.random());
				$("#addForm").submit();
