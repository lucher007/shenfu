...
<body>
        ...
        <form action="" method="post" id="searchForm" name="searchForm">
            ...
            <table width="100%">
		    	...
		    	<tr>
		    		...
		    		<td align="right">已确认产品信息：</td>
        			<td>
        				<select id="productconfirm" name="productconfirm" class="select" onchange="queryUserorder();">
			                   <option value="1" <c:if test="${userorder.productconfirm == '1' }">selected</c:if>>已确定</option>
			             </select>
        			</td>
		    	</tr>
   		    </table>
    ...
    <div id="tools">
		<div style="margin-bottom:5px">
			<a href="javascript:packUserorder();" class="easyui-linkbutton" iconCls="icon-tip"  plain="true">订单打包</a>
...
<script type="text/javascript">
         ...
         $('#userorderDG').datagrid({
              ...
              frozenColumns:[[
               ...
               columns: [[
			                  ...
			                  { field: 'visitorname', title: '上门测量员姓名',width:150,align:"center",},
			                  { field: 'statusname', title: '状态',width:150,align:"center",},
			                  { field: 'operatetime', title: '最新修改时间',width:150,align:"center",},
			                  { field: 'productconfirmname', title: '订单产品是否已确定',width:150,align:"center",},
              ]]
          });
	}
	...
	//将表单数据转为json
	 function paramsJson(){
	 	var json = {
		 		...
		 		address:$("#address").val(),
		 		status:$("#status").val(),
		 		productconfirm:$("#productconfirm").val(),
	 	};
	 	return json;
	 }
	...
	function packUserorder() {
        ...
        parent.addTab('订单打包信息','userorder/packInit?rid='+ Math.random()+'&id='+id);
	...
	function lookUsercontract() {
       ...
       parent.addTab('查看合同详情','usercontract/findByList?rid='+ Math.random()+'&ordercode='+ordercode);
    ...
    function lookUserorder() {
        ...
        parent.addTab('查看订单详情','userorder/lookInit?rid='+ Math.random()+'&id='+id);
