...
<body>
        ...
        <form action="" method="post" id="searchForm" name="searchForm">
            ...
            <table width="100%">
		    	...
		    	<tr>
		    		...
		    		<td align="right">未确认产品信息：</td>
        			<td>
        				<select id="productconfirm" name="productconfirm" class="select" onchange="queryUserorder();">
			                   <option value="0" <c:if test="${userorder.productconfirm == '0' }">selected</c:if>>未确定</option>
			             </select>
        			</td>
		    	</tr>
   		    </table>
    ...
    <div id="tools">
		<div style="margin-bottom:5px">
			<a href="javascript:updateUserproductconfirm();" class="easyui-linkbutton" iconCls="icon-tip"  plain="true">订单产品确认</a>
...
<script type="text/javascript">
	...
	function updateUserproductconfirm() {
        ...
        parent.addTab('订单产品确认修改','userorder/updateUserproductconfirmInit?rid='+ Math.random()+'&id='+id);
