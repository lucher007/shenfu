...
<body>
    ...
    <div id="tools">
		<div style="margin-bottom:5px">
			<a href="javascript:checkUserorder();" class="easyui-linkbutton" iconCls="icon-tip"  plain="true">订单结单</a>
...
<script type="text/javascript">
	...
	*/
	function checkUserorder(){
		...
		$.dialog.confirm('确认订单结单？', function(){ 
			var data = {
					     id: id
					   };
			var url="userorder/updateForCheck?rid="+Math.random();
