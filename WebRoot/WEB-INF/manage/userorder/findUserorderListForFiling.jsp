...
<body>
    ...
    <div class="seh-box">
        <form action="" method="post" id="searchForm" name="searchForm">
            <input type="hidden"  name="filingflag" id="filingflag" value="0">
   	...
   	<div id="tools">
		<div style="margin-bottom:5px">
			<a href="javascript:updateForFiling();" class="easyui-linkbutton" iconCls="icon-tip"  plain="true">订单归档</a>
...
<script type="text/javascript">
	...
	*/
	function updateForFiling(id){
		...
		$.dialog.confirm('确认订单归档？', function(){ 
			var data = {
							ids: ids
					   };
			var url="userorder/updateForFiling?rid="+Math.random();
	...
	function getChecked(){
		var ids = [];
		var rows = $('#userorderDG').datagrid('getChecked');
