...
<body>
    ...
    <div id="tools">
		<div style="margin-bottom:5px">
			<a href="javascript:confirmFirstArrival();" class="easyui-linkbutton" iconCls="icon-ok"  plain="true">确认首款到账</a>
...
<script type="text/javascript">
	...
	*首款到账确认
	*/
	function confirmFirstArrival(id){
		...
		$.dialog.confirm('确认首款到账？', function(){ 
			var data = {
					     id: id
					   };
			var url="userorder/updateFirstArrival?rid="+Math.random();
