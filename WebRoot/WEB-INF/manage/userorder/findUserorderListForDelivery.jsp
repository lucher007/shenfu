...
<body>
    ...
    <div id="tools">
		<div style="margin-bottom:5px">
			<a href="javascript:deliveryUserorder();" class="easyui-linkbutton" iconCls="icon-tip"  plain="true">订单发货</a>
...
<script type="text/javascript">
         ...
         $('#userorderDG').datagrid({
              ...
              frozenColumns:[[
               ...
               columns: [[
							  ...
							  { field: 'taskcode', title: '任务单编号',width:150,align:"center",},
	...
	function deliveryUserorder(id) {
        ...
        parent.addTab('订单发货信息','userorder/deliveryInit?rid='+ Math.random()+'&id='+id);
