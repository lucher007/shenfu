		...
		<form method="post" id="addForm" name="addForm">
				...
				<div class="easyui-panel" title="新产品信息" style="width:100%;">
					<table style="width:100%">
						<tr>
							...
							<td>
								<input type="text" id="newproductversion" name="newproductversion"  class="inp" value="">
							</td>
							<td align="right">旧产品状态：</td>
							<td>
								<select id="oldproductstatus" name="oldproductstatus" class="select" style="width: 110px;">
			...
			<div id="ft" style="padding:5px;">
					<cite> 
						...
						<a href="javascript:saveUserproductChangeVersion();" class="easyui-linkbutton" iconCls="icon-save">确认升级</a>
...
<script type="text/javascript">
  ...
  function checkVal() {
	    ...
	    if(selected == null){
	    	$.dialog.tips("请选择需要升级软包版本的产品", 2, "alert.gif");
			return false;
	    }
	  
		if ($("#newproductversion") != undefined && ($("#newproductversion").val() == "" || $("#newproductversion").val() == null )) {
			$.dialog.tips("请输入新的产品软件版本", 1, "alert.gif", function() {
				$("#newproductversion").focus();
			});
			return false;
		}
  ...
  function saveUserproductChangeVersion() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "userorder/saveUserproductChangeVersion");
			    $("#addForm").submit();
