...
<body>
			...
			<div class="easyui-panel" style="width:100%;" data-options="footer:'#ft'">
				<div class="easyui-panel" title="任务单信息" style="width:100%;">
					<table style="width:100%">
						...
						<tr>
							<td align="right">讲解人员编号：</td>
							<td><input type="text" class="inp" name="talkercode" id="talkercode" readonly="readonly" style="background:#eeeeee;" value="${userorder.usertask.talker.employeecode }">
							<td align="right">销讲解员姓名：</td>
							<td>
								<input type="text" class="inp" name="talkername" id="talkername" readonly="readonly" style="background:#eeeeee;" value="${userorder.usertask.talker.employeename }"> 
							</td>
							<td align="right">讲解人员电话：</td>
							<td><input type="text" class="inp" name="talkerphone" id="talkerphone" readonly="readonly" style="background:#eeeeee;" value="${userorder.usertask.talker.phone }"> </td>
						</tr>
					</table>
				</div>
						...
						<tr>
							 ...
							 <td >
								<select id="lockcoreflag" name="lockcoreflag" class="select" style="width: 200px;">
									<option value="0" <c:if test="${user.visittype == '0'}">selected</c:if>>不需要</option>
									<option value="1" <c:if test="${user.visittype == '1'}">selected</c:if>>需要</option>
								</select>
  ...
  function saveUserorder() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "userorder/save?rid="+Math.random());
				$("#addForm").submit();
