	...
	<form method="post" id="addForm" name="addForm">
    	...
    	<div class="easyui-panel" style="width:100%;" data-options="footer:'#ft'">
			...
			<div class="easyui-panel" title="订单信息" style="width:100%;">
					<table style="width:100%">
						...
						<tr>
							<td align="right">订单讲解人：</td>
							<td colspan="5"> 
								<input type="text" class="inp w200" name="talkercode" id="talkercode" readonly="readonly" style="background:#eeeeee;" value="${userorder.userorder.talkercode }">
								<input type="text" class="inp w200" name="talkername" id="talkername" readonly="readonly" style="background:#eeeeee;" value="${userorder.userorder.talker.employeename }">
		...
		<div id="ft" style="padding:5px;">
					<cite>
						...
						<a href="javascript:updateUserproduct();" class="easyui-linkbutton" iconCls="icon-save">修改产品</a>
...
<script type="text/javascript">
  ...
  function updateUserproduct() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "userorder/updateUserproduct?rid="+Math.random());
				$("#addForm").submit();
