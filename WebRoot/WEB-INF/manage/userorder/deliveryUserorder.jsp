		...
		<form method="post" id="addForm" name="addForm">
				...
				<div class="easyui-panel" title="发货信息" style="width:100%;">
					<table style="width:100%">
						<tr>
							...
							<td>
								<input type="text" id="deliverytime" name="deliverytime" value="${userorder.deliverytime}"
							...
							<td>
								<input type="text" id="deliverercode" name="deliverercode" class="inp" value="${userorder.deliverercode}" readonly="readonly" style="background:#eeeeee; width: 100px;" > 
							...
							<td>
								<input type="text" id="deliverername" name="deliverername"  class="inp" value="${userorder.deliverername}" readonly="readonly" style="background:#eeeeee;width: 100px;" >
							</td> 
							<td align="right">送货人电话：</td>
							<td>
								<input type="text" id="delivererphone" name="delivererphone" class="inp" value="${userorder.delivererphone}" readonly="readonly" style="background:#eeeeee;width: 100px;">
							</td> 
						</tr>
						<tr>
							<td align="right">发货快递名称：</td>
							<td>
								<input type="text" id="deliveryname" name="deliveryname"  class="inp" value="${userorder.deliveryname}">
							</td> 
							<td align="right">快递单编号：</td>
							<td>
								<input type="text" id="deliverycode" name="deliverycode" class="inp" value="${userorder.deliverycode}">
							</td> 
						</tr>
						<tr>
			...
			<div id="ft" style="padding:5px;">
					<cite> 
						...
						<a href="javascript:saveDelivery();" class="easyui-linkbutton" iconCls="icon-save" style="width:80px">保存</a>
...
// 		}
  ...
  function saveDelivery() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "userorder/saveDeliveryUserorder?rid="+Math.random());
				$("#addForm").submit();
