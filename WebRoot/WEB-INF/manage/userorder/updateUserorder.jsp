	...
	<form method="post" id="addForm" name="addForm">
			...
			<div class="easyui-panel" title="产品信息" style="width:100%;">
				<table style="width:100%">
			  		<tr>
						...
						<td >
							<input id="modelcode" name="modelcode"  class="easyui-combogrid"> <span class="red">*</span>
						</td>
					</tr>
					<tr>
						<td align="right">型号名称：</td>
						<td >
							<input type="text" class="inp" id="modelname" name="modelname"  value="" readonly="readonly" style="background:#eeeeee;">
						</td>
					</tr>
					<tr>
						<td align="right">原价格：</td>
						<td >
							<input type="text" class="inp" id="price" name="price"  value="" readonly="readonly" style="background:#eeeeee;"> <span class="red">*</span>
						</td>
				   </tr>
				   <tr>
						<td align="right">出售价格：</td>
						<td >
							<input type="text" class="inp" id="sellprice" name="sellprice"  value="" readonly="readonly" style="background:#eeeeee;"> <span class="red">*</span>
						</td>
				   </tr>
				   <tr>
		...
		<div id="ft" style="padding:5px;">
					<cite> 
						...
						<a href="javascript:updateUserorder();" class="easyui-linkbutton" iconCls="icon-save">保存修改</a>
...
<script type="text/javascript">
  ...
  function updateUserorder() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "userorder/update?rid="+Math.random());
				$("#addForm").submit();
