	...
	<form method="post" id="addForm" name="addForm">
			...
			<div class="easyui-panel" title="产品信息" style="width:100%;">
				<table style="width:100%">
				    ...
				    <tr>
				     ...
				     <tr>
						<td align="right">订单新金额：</td>
						<td >
							<input type="text" class="inp easyui-numberbox" id="newtotalmoney" name="newtotalmoney" > <span class="red">*</span>
						</td>
					 </tr>
			  	</table>
			</div>
		...
		<div id="ft" style="padding:5px;">
					<cite> 
						...
						<a href="javascript:updateProductfee();" class="easyui-linkbutton" iconCls="icon-save">修改订单金额</a>
...
<script type="text/javascript">
  ...
  function checkVal() {
	  if ($("#newtotalmoney") != undefined && ($("#newtotalmoney").val() == "" || $("#newtotalmoney").val() == null )) {
			$.dialog.tips("请输入订单新金额", 1, "alert.gif", function() {
				$("#newtotalmoney").focus();
			});
			return false;
		}
  ...
  function updateProductfee() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "userorder/updateProductfee?rid="+Math.random());
				$("#addForm").submit();
