              ...
              columns: [[
                  ...
                  { field: 'id1', title: '操作',width:80,align:"center",
            			formatter:function(val, row, index){ 
            				    ...
            				    if(contractno != null && row.contractno != ''){
            				    	var updateContent = '<a class="btn-edit" href="javascript:recreateContact('+ row.id +');" >重新生成</a>';
            				    	return updateContent;
            				    }else{
            				    	var updateContent = '<a class="btn-edit" href="javascript:createContact('+ row.id +');" >生成合同</a>';
            				    	return updateContent;
            				    }
  	          	        },
  	                },
