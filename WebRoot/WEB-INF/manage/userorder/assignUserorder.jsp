		...
		<form method="post" id="addForm" name="addForm">
				...
				<div class="easyui-panel" title="支付信息" style="width:100%;">
					<table style="width:100%">
						<tr>
							...
							<td><input type="text" class="inp" name="totalmoney" id="totalmoney" readonly="readonly" style="background:#eeeeee;" value="${userorder.userorder.totalmoney}"></td>
					...
					<table style="width:100%">
						<tr>
						 <td align="right">安装人员编号：</td>
							<td >
								<input type="text" class="inp" name="installercode" id="installercode" readonly="readonly" style="background:#eeeeee;" value="${userorder.installercode}">
							...
							<td><input type="text" class="inp" name="installername" id="installername" readonly="readonly" style="background:#eeeeee;" value="${userorder.installername}"></td>
							<td align="right">联系电话：</td>
							<td><input type="text" class="inp" name="installerphone" id="installerphone" readonly="readonly" style="background:#eeeeee;" value="${userorder.installerphone}"></td>
							<!--
						...
						<tr>
				            ...
				            <td colspan="3"> 
								<textarea id="content" name="content" style="width:550px; height:30px;"
			                       onKeyDown="checkLength('content',100)" onKeyUp="checkLength('content',100)"></textarea>
			...
			<div id="ft" style="padding:5px;">
					<cite> 
						...
						<a href="javascript:saveAssign();" class="easyui-linkbutton" iconCls="icon-save" style="width:80px">保存</a>
...
<script type="text/javascript" src="main/plugin/uploadify/jquery.uploadify.js"></script>
...
// 		}
  ...
  function saveAssign() {
		...
		$.dialog({
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "userorder/saveAssignUserorder?rid="+Math.random());
				$("#addForm").submit();
		...
		//$("#addForm").attr("action", "userorder/saveAssignUserorder");
	    //$("#addForm").submit();
	}  
   ...
   var orderDialog;
	...
	function chooseEmployee() {
		employeeDialog = $.dialog({
			...
			max : false,
			min : false,
			content : 'url:employee/findInstallerListDialog?rid='+Math.random()
		});
	}
