...
<div id="body">
	...
	<div id="userpayarrival" style="width:auto;"></div>
...
<script type="text/javascript">
	function initUserpayarrival(){
	    $('#userpayarrival').datagrid({
	         title: '财务审核到账的支付统计',
	         url:'userpaylog/userpayarrivalStatJson',
	...
	function saveDownloadFile(){
		$.dialog.confirmMultiLanguage('<spring:message code="page.confirm.execution"/>?', 
 		        ...
 		        function(){ 
 					$("#searchForm").attr("action", "userpaylog/exportBusinessExcel");
					$("#searchForm").submit();
 				}, function(){
 							});
	}
	...
	function queryUserpayarrival(){
		$('#userpayarrival').datagrid('reload',paramsJson());
	}
